...
main_dataset.load_initial_dataset(sin_x.multi_inputs, num_datapoints=5, bounds=[(0, 6), (0, 2), (0, 3), (0, 2), (2, 3)], minimization_flags=[False, True, True], sampling_method="grid", noise_level=0)
