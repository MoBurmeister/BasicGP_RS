...
multimultitaskgp = MultiMultitaskInitializer(dataset_manager=main_dataset)

multimultitaskgp.initially_setup_model()

multimultitaskgp.train_initially_gp_model()

bayesian_optimizer = BayesianOptimizer(multiobjective_model=multimultitaskgp, reference_point=torch.tensor([-1864.72022, -11.81993945, -0.2903999384], dtype=torch.float64), save_file_name="var_fac_0_0")

bayesian_optimizer.optimization_loop(num_max_iterations=70, num_min_iterations=1)
