...
# main_dataset.load_initial_dataset(num_datapoints=11, bounds=[(50, 150), (0.00333333, 0.00333333), (0.001, 0.001)], maximization_flags=[True, False], input_parameter_name=["laser_pwr", "laser_speed", "laser_width"], output_parameter_name=["hardening_time", "temp_div"], sampling_method="grid", noise_level=0, identifier=1)
