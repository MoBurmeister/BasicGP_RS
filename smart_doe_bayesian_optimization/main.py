...
print(main_dataset.historic_datasetinfo_list)

multisingletaskgp = MultiSingletaskGPInitializer(dataset=main_dataset, transfer_learning_method="initial_transfer", bool_transfer_averaging=False)
...
# bayesian_optimizer = BayesianOptimizer(multiobjective_model=multisingletaskgp, reference_point=torch.tensor([-1864.72022, -11.81993945, -0.2903999384], dtype=torch.float64), save_file_name="var_fac_-0_05")

# bayesian_optimizer.optimization_loop(num_max_iterations=10, num_min_iterations=1)
