...
vehicle_crash_function = FunctionFactory(variation_factor=variation_factor)

main_dataset = DataManager(external_input=False,
                           dataset_func=vehicle_crash_function.generate_car_crash_synthetic_data,
...
multitask = MultiMultitaskInitializer(dataset_manager=main_dataset)

multitask.initially_setup_model()    

multitask.train_initially_gp_model()
...
bayesian_optimizer = BayesianOptimizer(multiobjective_model=multitask, 
                                       bool_optional_ending_optimization_each_iteration=False, 
                                       reference_point=reference_point,
                                       save_file_name="OPT_Multitask")
